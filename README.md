...
| **Банковские СМС** | правила по отправителю, счёту и цифрам карты; пока — вставкой вручную, автоматически — после одобрения Google | нет |
...
Это **та же самая сборка, что и в Google Play**, подписанная Google: название,
версия и подпись совпадают, поэтому версия из Play встаёт поверх APK с GitHub
и наоборот, данные сохраняются.

**Google Play.** Идёт внутреннее тестирование. Пока Google не одобрил чтение СМС,
сообщения банка можно вставлять вручную (Настройки → Банковские сообщения);
уведомления банковских приложений читаются автоматически.
