...
interface Platform {
    ...
    /**
     * Прочитать QR-код со снимка камеры или из галереи. Возвращает текст кода;
     * null — человек передумал или кода на снимке не нашлось.
     */
     ...
     */
    /** Номер сборки — в Play Console он «код версии». Пусто, если платформа его не знает. */
    val build: String get() = ""

    /** Открыть страницу приложения в магазине, откуда его поставили. false — не из магазина. */
    fun openStorePage(): Boolean = false
