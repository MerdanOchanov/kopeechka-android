...
internal val RU_STRINGS: Map<String, String> = mapOf(
    ...
    "set.mainCurNote" to "В ней считаются баланс, бюджеты и отчёты. Счета в других валютах пересчитываются по курсу.",
    ...
    "cur.note" to "Курс — сколько долларов стоит одна единица валюты. Доллар здесь база, его курс всегда 1. Курсы задаются вручную: приложение никуда не ходит за ними и не требует интернета.",
    "cur.base" to "база",
    ...
    "cur.footer" to "Доллар — база курсов. Туркменский манат (TMT) уже в списке. Любую другую мировую валюту можно выбрать из каталога, а если её там нет — завести свою с собственным кодом и символом.",
    ...
    "cur.approxRate" to "{0} · ориентировочно {1} $",
    ...
    "cur.rate" to "Курс: сколько долларов за единицу",
    ...
    "msg.mainCurSet" to "Основная валюта — {0}",
    ...
    "msg.curRate" to "Укажите курс в долларах",
    "msg.curBase" to "Доллар — база курсов, его убрать нельзя",
