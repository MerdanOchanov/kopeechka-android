...
internal val RU_STRINGS: Map<String, String> = mapOf(
    ...
    "cur.note" to "Курс — сколько рублей стоит одна единица валюты. Рубль здесь база, его курс всегда 1. Курсы задаются вручную: приложение никуда не ходит за ними и не требует интернета.",
    "cur.base" to "база",
    ...
    "cur.footer" to "Туркменский манат (TMT) уже в списке. Любую другую мировую валюту можно выбрать из каталога, а если её там нет — завести свою с собственным кодом и символом.",
    ...
    "cur.rate" to "Курс: сколько рублей за единицу",
    ...
    "msg.curRate" to "Укажите курс в рублях",
    "msg.curBase" to "Рубль — база курсов, его убрать нельзя",
